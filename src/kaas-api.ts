/**
 * Copied from: https://github.com/runtimeverification/kaas/blob/develop/kaas-web/src/api-types.ts
 *
...
export interface paths {
  ...
  '/api/admin/orgs/{organizationName}/vaults/{vaultName}/caches/{cacheHash}': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    put?: never;
    post?: never;
    /** Hard delete cache (admin only) */
    delete: operations['CacheController_hardDeleteCache'];
    options?: never;
    head?: never;
    patch?: never;
    trace?: never;
  ...
  '/api/orgs/{organizationName}/vaults/{vaultName}/caches/{cacheHash}': {
    ...
    /** Get cache by hash */
    get: operations['CacheController_getCacheByHash'];
    put?: never;
    post?: never;
    /** Delete cache */
  ...
  '/api/orgs/{organizationName}/vaults/{vaultName}/caches/{cacheHash}/report/publish': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    post: operations['CacheController_publishCacheReport'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/orgs/{organizationName}/vaults/{vaultName}/caches/{cacheHash}/report/unpublish': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    get?: never;
    put?: never;
    /** Unpublish cache report */
    post: operations['CacheController_unpublishCacheReport'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/orgs/{organizationName}': {
    ...
    patch: operations['OrganizationController_updateOrganizationName'];
    trace?: never;
  };
  ...
  '/api/jobs/{jobId}/json-report': {
    ...
    /** Get the JSON report of a job */
    get: operations['JobController_getJobJsonReport'];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface components {
  schemas: {
    ...
    ICache: {
      ...
      /**
       * @description The date and time the report was last published.
       * @example 2021-10-10T00:00:00.000Z
       */
      reportPublishedAt?: string | null;
      /**
       * @description The date and time the cache was deleted.
       * @example 2021-10-10T00:00:00.000Z
       */
      deletedAt?: string | null;
    };
...
export interface operations {
  ...
  CacheController_hardDeleteCache: {
    parameters: {
      query?: never;
      header?: never;
      path: {
  ...
  CacheController_getCacheByHash: {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    responses: {
      200: {
        ...
        content: {
          'application/json': components['schemas']['ICache'];
        };
      };
    };
  };
  ...
  CacheController_publishCacheReport: {
    parameters: {
      query?: never;
      header?: never;
      path: {
  ...
  CacheController_unpublishCacheReport: {
    parameters: {
      query?: never;
      header?: never;
      path: {
  ...
  OrganizationController_updateOrganizationName: {
    parameters: {
      query?: never;
      header?: never;
      path: {
  ...
  JobController_getVaultJobs: {
    parameters: {
      query?: {
        /**
         * @description The field to sort jobs by. Default: createdAt
         * @example createdAt
         */
        sort?: PathsApiOrgsOrganizationNameVaultsVaultNameJobsGetParametersQuerySort;
        /**
         * @description The direction to sort jobs. Default: desc
         * @example desc
         */
        direction?: PathsApiOrgsOrganizationNameVaultsVaultNameJobsGetParametersQueryDirection;
        /**
        ...
        per_page?: number;
        /**
         * @description The profile to filter jobs by. If not provided, all jobs are returned.
         * @example default
         */
        profile?: string;
        /**
         * @description The commit SHA to filter jobs by. Note: this has to be a full SHA. If not provided, all jobs are returned.
         * @example 4f7c2462d3ff30149cd2a8651d33cb24888a55d0
         */
        commit?: string;
        /**
         * @description Filter jobs by their status. If not provided, all jobs are returned.
         * @example success
         */
        status?: PathsApiOrgsOrganizationNameVaultsVaultNameJobsGetParametersQueryStatus;
      };
      header?: never;
      path: {
  ...
  JobController_getOrganizationJobs: {
    parameters: {
      query?: {
         ...
         * @example createdAt
         */
        sort?: PathsApiOrgsOrganizationNameJobsGetParametersQuerySort;
        /**
         * @description The direction to sort jobs. Default: desc
         * @example desc
         */
        direction?: PathsApiOrgsOrganizationNameJobsGetParametersQueryDirection;
        /**
         * @description The page number to retrieve. Default: 1
         * @example 1
         */
         ...
         * @example success
         */
        status?: PathsApiOrgsOrganizationNameJobsGetParametersQueryStatus;
      };
      header?: never;
      path: {
        /** @description The name of the organization. */
  ...
  JobController_getJobJsonReport: {
    parameters: {
      query?: {
        /**
         * @description Include severity levels in the JSON report. Default: false
         * @example true
         */
        include_severities?: PathsApiJobsJobIdJsonReportGetParametersQueryInclude_severities;
      };
      header?: never;
      path: {
        jobId: string;
    ...
    requestBody?: never;
    responses: {
      /** @description Returns the JSON report of the job */
      200: {
        headers: {
          [name: string]: unknown;
        };
...
export enum PathsApiOrgsOrganizationNameVaultsVaultNameJobsGetParametersQuerySort {
  createdAt = 'createdAt',
  updatedAt = 'updatedAt',
}
export enum PathsApiOrgsOrganizationNameVaultsVaultNameJobsGetParametersQueryDirection {
  asc = 'asc',
  desc = 'desc',
}
export enum PathsApiOrgsOrganizationNameVaultsVaultNameJobsGetParametersQueryStatus {
  pending = 'pending',
  running = 'running',
  success = 'success',
  failure = 'failure',
...
export enum PathsApiOrgsOrganizationNameJobsGetParametersQuerySort {
  createdAt = 'createdAt',
  updatedAt = 'updatedAt',
}
export enum PathsApiOrgsOrganizationNameJobsGetParametersQueryDirection {
  asc = 'asc',
  desc = 'desc',
}
export enum PathsApiOrgsOrganizationNameJobsGetParametersQueryStatus {
  pending = 'pending',
  running = 'running',
  success = 'success',
  failure = 'failure',
...
export enum PathsApiJobsJobIdJsonReportGetParametersQueryInclude_severities {
  true = 'true',
  false = 'false',
}
