...
export async function getJobStatusByJobId(client: Client<paths>, jobId: string): Promise<components["schemas"]["IJob"]> {
...
export async function fetchComputeJobs(client: Client<paths>, testController: vscode.TestController) {
...
export async function getLatestJobStatusFor(client: Client<paths>, organizationName: string, vaultName: string, profileName: string): Promise<components["schemas"]["IJob"]> {
